...
class ListUa extends RiskCommand
{
    ...
    public function handle($message, $match = []) { if (!$this->authorized($message)) return; $this->sendIndicatorPage('ua', 'UA 风险名单', 'risk_ua', (int)($message->args[0] ?? 1), (int)$message->chat_id); }
